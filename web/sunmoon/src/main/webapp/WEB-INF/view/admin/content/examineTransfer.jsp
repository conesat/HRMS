					...
					<table class="layui-table">
						...
						<thead>
							...
							<tr style="background-color: #ffffff">
								...
								<td id='check_state' rowspan="5"></td>
							</tr>
							<tr>
								<th>现任部门</th>
								<th>现任岗位</th>
							...
							<tr style="background-color: #ffffff">
								<td id='transfer_department_name_old'></td>
								<td id='transfer_position_name_old'></td>
							</tr>
							...
							<tr style="background-color: #ffffff">
								<td id='transfer_position_name_new'></td>
								<td id='transfer_department_name_new'></td>
							</tr>
						</thead>
					</table>
							...
							<div class="layui-form-item my-form-item" id="submit-button">
								<div class="layui-btn-group">
									<button class="layui-btn my-button" lay-submit
										lay-filter="check-apply" id="add-change">完成</button>
...
<script type="text/javascript" src="res/js/admin/examineTransfer.js"></script>
</html>