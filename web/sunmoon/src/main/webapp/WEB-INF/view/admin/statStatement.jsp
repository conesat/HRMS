			...
			<div class="layui-side-scroll">
				...
				<ul class="layui-nav layui-nav-tree" lay-filter="test" id='menue-ul'>
					<li class="layui-nav-item layui-nav-itemed"><a class=""
						href="javascript:;"><img alt="..." src="res/image/icon/statistical_report.png" width="14" height="14">  统计报表</a>
						<dl class="layui-nav-child">
							<dd id="staffCharts">
								<a href="javascript:;" onclick="changeBody('staffCharts')"><img alt="..." src="res/image/icon/basic_setup.png" width="14" height="14">  人员报表</a>
							</dd>
							<dd>
								<a href="javascript:;"><img alt="..." src="res/image/icon/organizational_structure.png" width="14" height="14">  考勤报表</a>
							</dd>
							<dd>
								<a href="javascript:;"><img alt="..." src="res/image/icon/jobmanagement.png" width="14" height="14">  申请报表</a>
							</dd>
						</dl></li>
