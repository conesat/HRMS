				...
				<div class="content-form">
					...
					<table class="layui-table">
						...
						<thead>
							...
							<tr style="background-color: #ffffff">
								<td id='expense_department'></td>
								<td id=expense_post></td>
								<td id='expense_type' rowspan="3"></td>
							</tr>
							<tr>
								<th>合计金额</th>
								<th>实际金额</th>
							...
							<tr style="background-color: #ffffff">
								<td id='expense_total_price'></td>
								<td id='expense_actual_price'></td>
							</tr>
						</tbody>
					</table>
...
<script type="text/javascript" src="res/js/admin/examineExpense.js"></script>
</html>