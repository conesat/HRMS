			...
			<div id='add-post-content' style="display: none;">
				<div class="content-form">
					...
					<table class="layui-table">
						...
						<tbody>
							<tr>
								<td id='evection_acc'></td>
								<td id='evection_acc_position'></td>
								<td id='evection_vehicle'></td>
							</tr>
						</tbody>
						...
						<tbody>
							<tr>
								<td id='evection_start_time'></td>
								<td id='evection_end_time'></td>
							</tr>
						</tbody>
					</table>
					...
					<table class="layui-table">
						<thead>
							<tr style="background-color: #ffffff">
								<th id="evection_path"></th>
							</tr>
						</thead>
					</table>
					<fieldset class="layui-elem-field layui-field-title"
						style="margin-bottom: 0px;">
						<legend>需办事宜简述</legend>
					</fieldset>
					<table class="layui-table">
						<thead>
							<tr style="background-color: #ffffff">
								<th id="evection_msg"></th>
							</tr>
						</thead>
					</table>
...
<script type="text/javascript" src="res/js/admin/examineEvection.js"></script>
</html>