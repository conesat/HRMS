			...
			<div id='add-post-content' style="display: none;">
				<div class="content-form">
					...
					<table class="layui-table">
						...
						<tbody>
							<tr>
								<td id='rel_rec_title'></td>
								<td id='position_id'></td>
								<td id='rel_rec_number'></td>
								<td id='rel_rec_money'></td>
								<td id='rel_rec_desc'></td>
								<td id='apply_time'></td>
...
<script type="text/javascript" src="res/js/admin/examineRrcruit.js"></script>
</html>