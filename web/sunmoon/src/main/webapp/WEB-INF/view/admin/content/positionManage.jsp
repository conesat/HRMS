...
<div class="layui-card">
  <div class="layui-card-header"><h2 class="div-title">职位管理</h2></div>
  <div class="layui-card-body">
     <!-- 顶部工具栏 -->
	<div class="map-tools">

		<button class="layui-btn layui-btn-sm layui-btn-normal" id='add-post' >
		...
		<div class="search-filter-main">
			...
			<div id='filter-ul-div' class="filter-ul-div">
				<form class="layui-form">
					<ul id='filter-ul'>
						<li><input type="checkbox" value="position_name" title="职位名称"
							lay-skin="primary" lay-filter='filter' checked></li>
						<li><input type="checkbox" value="position_msg" title="职位描述"
							lay-skin="primary" lay-filter='filter' checked></li>
						<hr>
					...
					<div
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" id="post_name" name="position_name" required
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="post_id" id='post_id' lay-search required lay-verify="required" >
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<select name="rank_level" id='rank_level' lay-search required lay-verify="required" >
						...
						<div class="layui-form-item layui-form-text">
							...
							<div class="layui-input-block">
								<textarea id='post_msg' name="position_msg" placeholder="请输入内容"
...
<script type="text/javascript" src="res/js/admin/positionManage.js"></script>
