					...
					<div id='filter-ul-div' class="filter-ul-div">
						<form class="layui-form">
							<ul id='filter-ul'>
								...
								<li><input type="checkbox" value="post_msg" title="职务描述"
									lay-skin="primary" lay-filter='filter' checked></li>
								<hr>
						...
						<form class="layui-form" action="" id="add-post-form">
							<div
								...
								<div class="layui-form-item layui-form-text">
									...
									<div class="layui-input-block">
										<textarea id='post_msg' name="post_msg" placeholder="请输入内容"
...
<script type="text/javascript" src="res/js/admin/postManage.js"></script>
