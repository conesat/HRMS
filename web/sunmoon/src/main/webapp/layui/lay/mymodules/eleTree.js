            ...
            arr.forEach(function(val,index) {
                var b=['<div class="eleTree-node ',spread?'eleTree-hide':"",'" eleTree-floor="'+count+'">'
                    ,'<div class="eleTree-node-content" style="padding-left: '+18*count+'px;">'
                        ...
                        ,'<span class="eleTree-node-content-label">'+val.power_name+"&nbsp;&nbsp;(ps:"+val.power_msg+")"+'</span>'
                    ,'</div>'
        ...
        getCheckedData: function() {
         ...
         //   var set=new Set();
            $(this.elem+" input[eletree-status='1']").each(function(index,item) {
                ...
                var d=self.reInitData(node).currentData.power_id;
                self.checkedData.add(d);
                //set.add(self.reInitData(node).currentData.power_id);
                //console.log();
            })
